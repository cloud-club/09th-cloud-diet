...
> 시즌 2 Week 2 · 멤버: **@m1cks** · 배정 노트: _단독_
...
시즌 1: S1-032 (RI family 미스매치) + S1-033 (SP coverage gap) + S1-034 (멀티 계정 미통합)

> 시즌 1 단일 시나리오들은 각각 명확한데, 결합되면 단일 에이전트로 발견 어려움. 이번 주차 과제의 핵심 함정.

## 3. 단일 에이전트로 풀 때의 문제

1 계정만 보면 RI 구매 자체는 정상. 12 계정 cross-account 비교가 컨텍스트 한계.
...
"account-A의 m5 RI utilization 65%, account-B는 m5 on-demand 청구 → Org RI sharing 활성화 시 cross-coverage" 통찰.

## 5. 예상 비용 영향

$1,875/월 (Org RI sharing 가정)
...
`members/m1cks/season-2/submissions/week-02/MA-005/` 아래:
...
- [시나리오 카탈로그 v1.0 (상세본)](../../../../../docs/SCENARIOS_S2_DETAILED.md#ma-005)
