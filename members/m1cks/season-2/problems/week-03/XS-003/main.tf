...
resource "aws_lb" "comp2_lb-pzjz8f" {
  name               = "lb-pzjz8f"
  internal           = false
  load_balancer_type = "application"
  security_groups    = [aws_security_group.lb-pzjz8f_sg.id]
...
resource "aws_lb" "comp2_lb-xz7ylo" {
  name               = "lb-xz7ylo"
  internal           = false
  load_balancer_type = "application"
  security_groups    = [aws_security_group.lb-xz7ylo_sg.id]
  subnets = var.public_subnet_ids
